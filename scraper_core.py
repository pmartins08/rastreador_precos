...
def gpus(t):
 ds=[g for g in GPU_MODELOS if g in t]
 if ds:return ds,'dedicada',ds[0]
 if any(x in t for x in GPU_GEN):return [],'dedicada',None
 if any(x in t for x in IGPU):return [],'integrada',None
