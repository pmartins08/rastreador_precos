...
import store_access_guard


class StoreAccessGuardTests(unittest.TestCase):
    def _module(self):
        module = types.SimpleNamespace()
        module._STORE_ACCESS_GUARD_INSTALLED = False
    ...
    def test_new_strategy_archives_old_stats_and_starts_fresh(self):
        module = self._module()
        store_access_guard.install(module)
    ...
    def test_worten_sitemap_rejects_accessory_that_mentions_laptop_family(self):
        self.assertFalse(
            store_access_guard._worten_sitemap_product_url(
